...
<head>
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key= =places&callback=initialize" async defer></script>-->
...
<body class="login-page">
    <div id="app">
        ...
        <div class="page-header header-filter" style="background-image: url('../img/welcome/login.jpg'); background-size: cover; background-position: top center;">
